...
//     return (
//         <div className="p-6">
//             <h2 className="text-2xl font-bold mb-4">Enterprise Management</h2>
...
//                     {enterprises.map((ent) => (
//                         <tr key={ent.id}>
//                             <td className="border p-2">{ent.name}</td>
//                             <td className="border p-2">{ent.location}</td>
//                             <td className="border p-2">{ent.contact_info}</td>
